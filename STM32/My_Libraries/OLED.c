...
//    uint8_t i;
//    uint8_t charIndex;
//    uint8_t chineseCount = strlen(Chinese) / 2;  // GB2312每个汉字占2字节
//    
//    for (i = 0; i < chineseCount; i++) 
//    {
//        // 查找汉字
//        for (charIndex = 0; ; charIndex++) 
//        {
//            // 检查是否到末尾（最后一个汉字Index为空）
//            if (OLED_CF16x16[charIndex].Index[0] == 0) 
//            {
//                // 没找到，使用最后一个（默认图形）
//                break;
//            }
//            
//            // GB2312：直接比较2个字节
//            if (OLED_CF16x16[charIndex].Index[0] == Chinese[i * 2] && 
//                OLED_CF16x16[charIndex].Index[1] == Chinese[i * 2 + 1]) 
//            {
//                break; // 找到了
//            }
//        }
//        
//        // 显示汉字
//        OLED_ShowImage(X + i * 16, Y, 16, 16, OLED_CF16x16[charIndex].Data);
//    }
//    
//    OLED_Update(); // 更新显示
//}
