...
void usart_SendCmd(uint8_t *cmd,uint8_t num){
  HAL_UART_Transmit(&huart5,cmd, num, 100);
}
...
// /*can*/
// void Emm_V5_Vel_Control_CAN(uint8_t addr, uint8_t dir, uint16_t vel, uint8_t acc, bool snF)
// {
//   uint8_t cmd[16] = {0};
...
// void Emm_V5_Synchronous_motion_CAN(uint8_t addr)
// {
//   uint8_t cmd[16] = {0};
...
//   * @retval   地址 + 功能码 + 命令状态 + 校验字节
//   */
// void Emm_V5_Pos_Control_CAN(uint8_t addr, uint8_t dir, uint16_t vel, uint8_t acc, uint32_t clk, bool raF, bool snF)
// {
//   uint8_t cmd[16] = {0};
...
//   * @retval   地址 + 功能码 + 命令状态 + 校验字节
//   */
// void Emm_V5_Origin_Trigger_Return_CAN(uint8_t addr, uint8_t o_mode, bool snF)
// {
//   uint8_t cmd[16] = {0};
